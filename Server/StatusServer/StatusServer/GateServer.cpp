...
//GateServer相当于服务Verifycode的客户端（采用了grpc通信）
...
//    const char* redis_password = "123456";//不能是string类型，否则会报错
...
//    assert(RedisMgr::GetInstance()->Set("blogwebsite", "crh.club"));
//    std::string value = "";
//    assert(RedisMgr::GetInstance()->Get("blogwebsite", value));
//    assert(RedisMgr::GetInstance()->Get("nonekey", value) == false);
//    assert(RedisMgr::GetInstance()->HSet("bloginfo", "blogwebsite", "crh.club"));
